...
_DAMAGE_PASCAL_VOC_SEG_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 97676,
        'trainval': 104653,
        'val': 6977,
...
_PART_PASCAL_VOC_SEG_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 19,
        'trainval': 27,
        'val': 8,
...
_DATASETS_INFORMATION = {
    ...
    'damage_pascal_voc_seg':_DAMAGE_PASCAL_VOC_SEG_INFORMATION,
    'part_pascal_voc_seg':_PART_PASCAL_VOC_SEG_INFORMATION,
}
